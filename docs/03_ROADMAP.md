...
real API. **Next up — `#14` debt & credit trends** (the analysis area's last slice), then hardening
(`#15`–`#16`). Prior slice: **`#12` budget-vs-actual — ✅ Done** (151 + 1 e2e).
