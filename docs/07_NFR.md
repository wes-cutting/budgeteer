...
| Web initial JS bundle (gz) | < 140 KB gz (re-baselined 2026-07-06; was 120)³ | Production `vite build`, single chunk | **125.27 KB gz** (+ 5.23 KB gz CSS, re-measured 2026-07-07 · UXR9)³ | `npm run build --workspace @budgeteer/web` (Vite prints gzip sizes) |
